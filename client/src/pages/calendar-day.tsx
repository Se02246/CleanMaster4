    ...
    <>
      ...
      {isLoadingApartments ? (
        ...
        <div className="text-center py-8 bg-white rounded-lg shadow">
          ...
          <h3 className="text-xl font-medium text-gray-600 mb-2">Nessun appartamento per questa data</h3>
          <p className="text-gray-500 mb-4">
            Non ci sono appartamenti programmati per il {formattedDate}.
          </p>
          <Button 
            onClick={handleOpenAddModal}
            className="bg-[#70fad3] hover:bg-[#70fad3]/90 text-dark font-medium px-4 py-2 rounded-lg transition-colors"
          >
            <i className="fas fa-plus mr-2"></i> AGGIUNGI APPARTAMENTO
          </Button>
        </div>
      )}
